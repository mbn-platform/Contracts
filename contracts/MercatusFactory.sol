...
contract MercatusFactory {
    function makeInstance(uint _duration, uint256 _maxLoss, uint256 _startBallance, uint256 _targetBallance, uint256 _amount,  string _investor, address _investorAddress, string _trader, address _traderAddress, uint256 offer, uint _currency)
    payable
    returns (address){
